...
<?php endif; ?>
  ...
  margin-top: 0px;">Does your ecobrick photo need rotating?  If so use the arrows above.</p></div>
            ...
            <h2 id="ecobrick-logged-title"><span data-lang-id="000-Ecobrick">Ecobrick</span> <?php echo $serial_no; ?> <span data-lang-id="001-form-title"> is almost logged...</span></h2>
  ...
  margin-bottom: 15px;"><span id="character-counter">256</span> <span data-lang-id="024X-char-remaining"><span></p>
        ...
        <h3>🙏 💚 🌏</h3>
                ...
                <span style="color:green;">✔</span> <span data-lang-id="015-vision-added">Vision (if set) was successfully added to ecobrick record </span> <?php echo $ecobrick_unique_id; ?>.
            </div>
