...
$(document).ready(function () {
    ...
    // 🟡 Load the next recipient via AJAX
    ...
    $('#email-form').on('submit', function (event) {
        ...
        const isTestMode = testSendEnabled();
        ...
        $.ajax({
            url: "", // Same page handles form submission
            type: "POST",
            data: {
                send_email: "1",
            ...
            success: function () {
                if (isTestMode) {
                    ...
                    // Wait a bit, then fetch the next
                    setTimeout(() => {
                        fetchNextRecipient();
                    }, 500);
                }
