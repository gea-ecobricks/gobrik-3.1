...
<div class="clouds-new2" style=" margin-bottom:25px;background-color:var(--general-background);">
  ...
  flex-flow: column;">
        ...
        <div class="sign-buttons" style="display:flex;flex-flow:row;justify-content: center;">
            ...
            <div>
                <button type="button" aria-label="Sign up" onclick="location.href='https://buwana.ecobricks.org/en/signup-1.php?gbrk_f2c61a85a4cd4b8b89a7" class="sign-uppp" style="cursor:pointer;">
