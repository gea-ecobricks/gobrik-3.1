...
<div class="clouds-new2" style=" margin-bottom:25px;background-color:var(--general-background);">
  ...
  flex-flow: column;">
        ...
        <div class="sign-buttons" style="display:flex;flex-flow:row;justify-content: center;">
            <div>
                <button type="button" aria-label="sign in" class="sign-innn" onclick="location.href='https://buwana.ecobricks.org/<?php echo $lang; ?>/login.php?app=gbrk_f2c61a85a4cd4b8b89a7'" title="Click here to sign in" style="cursor:pointer;">
