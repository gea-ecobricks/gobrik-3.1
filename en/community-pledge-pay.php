...
<?php require_once("../includes/community-pledge-pay-inc.php"); ?>
...
<div id="form-submission-box" class="pledge-pay-page-shell">
    <div class="form-container pledge-pay-container">
        <div class="pledge-pay-content-wrap">
            ...
            <!-- Your Community Commitment summary -->
            <div class="pledge-pay-pledge-card">
                <div>
                    <div class="pledge-pay-pledge-label">Your Community Commitment</div>
            ...
            <div class="pledge-pay-graph-section">
                <?php
                $graph_title = 'Community Course Progress';
            ...
            <?php if ($payment_state === 'pending'): ?>
                ...
                <div class="pledge-pay-state-card state-pending">
                    ...
                    <h3>Your Community Course Request is Under Review</h3>
                    <p>
                        Your community training request is being reviewed by the training team.
                        They will confirm the dates and details and send you a payment link once everything is set.
                    </p>
                    <?php if (!empty($users_email_address)): ?>
                        <p>We'll email you at <strong><?php echo htmlspecialchars($users_email_address, ENT_QUOTES, 'UTF-8'); ?></strong> when your community training is confirmed and payment is ready.</p>
                    <?php endif; ?>
            ...
            <?php elseif ($payment_state === 'payment_due'): ?>
                ...
                <div class="pledge-pay-state-card state-payment-due">
                    ...
                    <h3>Your Community Training is Confirmed!</h3>
                    <p>
                        Great news — your community training request has been confirmed.
                        The full community course amount of <strong><?php echo $pledge_display_main; ?></strong>
                        is now due.
                    </p>
                    <p><em>This is the full community course amount, covering all participants from your community.</em></p>
                    <?php if (!empty($payment_deadline_display)): ?>
                        <p>Please complete payment by <strong><?php echo $payment_deadline_display; ?></strong>. We'll send you the final course access details and joining instructions for your community once payment is confirmed.</p>
                    <?php else: ?>
                        <p>We'll send you the final course access details and joining instructions for your community once payment is confirmed.</p>
                    <?php endif; ?>
            ...
            <?php elseif ($payment_state === 'paid'): ?>
                ...
                <div class="pledge-pay-state-card state-paid">
                    ...
                    <h3>Community Course Payment Received!</h3>
                    <p>
                        Your community course payment of <strong><?php echo $pledge_display_main; ?></strong> for
                        <strong><?php echo $training_title; ?></strong> has been received.
                        Check your email at <strong><?php echo htmlspecialchars($users_email_address, ENT_QUOTES, 'UTF-8'); ?></strong> for your final joining instructions for your community.
                    </p>
                ...
                <div class="pledge-pay-state-card state-cancelled">
                    ...
                    <h3>
                        <?php echo ($payment_state === 'expired')
                            ? 'This Community Training Request Has Expired'
                            : 'This Community Training Has Been Cancelled'; ?>
                    </h3>
                    <p>
                        <?php if ($payment_state === 'expired'): ?>
                            Unfortunately, this community training request was not confirmed in time.
                            No payment has been collected.
                        <?php else: ?>
                            This community training has been cancelled. No payment has been collected.
                        <?php endif; ?>
                    </p>
