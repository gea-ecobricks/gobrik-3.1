...
$ecobrick_stmt = $gobrik_conn->prepare('SELECT serial_no, weight_g, status FROM tb_ecobricks WHERE ecobrick_unique_id = ?');
if (!$ecobrick_stmt) {
    http_response_code(500);
...
$ecobrick_stmt->bind_result($serial_no, $weight_g, $current_status);
