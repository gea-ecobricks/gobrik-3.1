...
<div id="main-menu-overlay" class="overlay-settings" style="display:none;">
  ...
  <!-- Desktop sidebar close button (top-right corner, visible only when sidebar-panel class is active) -->
...
-->
  ...
  <div class="menu-page-item">
    ...
    <span class="status-circle" style="background-color: pink;" title="Working."></span>
  </div>
    ...
    <div class="menu-page-item">
      ...
      <span class="status-circle" style="background-color:purple;" title="Working. Not translated."></span>
    </div>
    </div>
