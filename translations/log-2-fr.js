...
const fr_Page_Translations = {
 ...
 "037-submit-upload-button": '<input type="submit" value="⬆️ Télécharger la Photo" id="upload-progress-button" aria-label="Soumettre la photo pour téléchargement">',

    "underDensityTitle": "Densité Inférieure à la Norme",
    "underDensityMessage": "La densité de votre écobrique de ${density} est inférieure à la norme GEA de 0,33g/ml. Veuillez vérifier que vous avez bien entré le poids et le volume. Sinon, ajoutez plus de plastique pour atteindre la densité minimale. Les directives GEA sont conçues pour garantir l’intégrité structurelle, la sécurité incendie, et la réutilisabilité de l’écobrique.",
    "lowDensityTitle": "Densité Faible",
    "lowDensityMessage": "Attention! La densité de votre écobrique de ${density} est basse. Elle respecte la norme minimale de 0,33g/ml, mais elle est moins dense, moins sûre au feu et moins réutilisable. Enregistrez cette écobrique, mais essayez d’ajouter plus de plastique la prochaine fois.",
    "greatJobTitle": "Bien joué!",
    "greatJobMessage": "La densité de votre écobrique de ${density} est idéale. Elle respecte la norme minimale de 0,33g/ml, ce qui la rend dense, sûre contre le feu et réutilisable.",
    "highDensityTitle": "Densité Élevée",
    "highDensityMessage": "Attention, la densité de votre écobrique de ${density} est très élevée. Votre bouteille de ${volume} remplie de ${weight} de plastique est sous la densité maximale de 0,73g/ml, mais cette densité élevée la rend presque trop dense et trop lourde pour certaines applications d’écobrique. Continuez, mais gardez cela à l’esprit pour la prochaine fois.",
    "overMaxDensityTitle": "Densité Maximale Dépassée",
    "overMaxDensityMessage": "La densité de votre écobrique de ${density} dépasse la norme GEA de 0,73g/ml. Veuillez vérifier que vous avez bien entré le poids et le volume. Sinon, réduisez le plastique dans votre écobrique. Les directives GEA sont conçues pour garantir la sécurité et la réutilisabilité de l'écobrique pour toutes les applications à court et long terme.",
    "geaStandardsLinkText": "Normes GEA",
    "nextRegisterSerial": "Suivant: Enregistrer le Numéro de Série",
    "goBack": "Retour",

    "inserts-title": "Inserts en Plastique",
    "inserts-text": "Pour une durabilité maximale du numéro de série, écrivez votre numéro de série sur un morceau de plastique rigide blanc avec un marqueur permanent et insérez-le dans l'écobrique terminée.",

    "nailvarnish-title": "Vernis à Ongles",
    "nailvarnish-text": "Écrivez le numéro de série en utilisant un vieux flacon de vernis à ongles.",

    "enamel-title": "Peinture Émail",
    "maker-text": "Écrivez le numéro de série en utilisant un pinceau et de la peinture à l'huile/émail.",

    "marker-title": "Marqueur Permanent",
    "maker-text": "Écrivez le numéro de série en utilisant un marqueur permanent (pas un marqueur de tableau ou à base d'eau).",

    "035-selfie-upload-box": '<div class="photo-upload-container" data-lang-id="035-selfie-upload-box"><label for="selfie_photo_main" class="custom-file-upload">📷 Ajouter une Photo Selfie <input type="file" id="selfie_photo_main" name="selfie_photo_main" onchange="displayFileName(\'selfie_photo_main\', \'file-name-selfie\')"></label><span id="file-name-selfie" class="file-name">Aucun fichier sélectionné</span><p class="form-caption">Téléchargez votre selfie écobrique.</p></div>',
"013b-see-examples": '👁️ Voir un exemple d’<a href="#" onclick="showModalInfo(\'inserts\')" class="underline-link">inserts en plastique</a>, <a href="#" onclick="showModalInfo(\'enamel\')" class="underline-link">peinture émail</a>, <a href="#" onclick="showModalInfo(\'marker\')" class="underline-link">marqueur permanent</a> et de <a href="#" onclick="showModalInfo(\'nailvarnish\')" class="underline-link">vernis à ongles</a>',
