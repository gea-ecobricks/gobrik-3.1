...
<div id="footer-full" style="margin-top:-10px">
        ...
        <div class="footer-conclusion">
            <div class="row" style="overflow-x: clip;"> <!--FIX: This should be fixed to no overflow-->
                ...
                <div class="virtue" data-lang-id="416x-banner-earth-enterprise">
                    <a href="https://ecobricks.org/<?php echo ($lang); ;?>/about.php" target="_blank"><img src="../webps/banners/forearth-dark-350px.webp" style="width:225px" alt="Click to learn more about our Earth Enterprise structure" loading="lazy" title="Learn more about our Earth Enterprise structure"></a>
                </div>

                <div class="virtue" data-lang-id="417x-banner-eco-impacts">
                    <a href="https://ecobricks.org/<?php echo ($lang); ;?>/regenreports.php" target="_blank"><img src="../webps/banners/762-disclose-dark-350px.webp" style="width:225px" alt="See a full and live breakdown of our 2023 ecological impacts on the GoBrik.com" loading="lazy" title="Click through to see a full and live breakdown of our 2023 ecological impacts on the GoBrik.com"></a>
                </div>


                <div class="virtue" data-lang-id="418x-banner-open-books">
                    <a href="https://ecobricks.org/<?php echo ($lang); ;?>/open-books.php" target="_blank"><img src="../webps/banners/openbooks-dark-350px.webp" style="width:225px"  alt="Click through to see our live financial tracking" loading="lazy" title="Click through to see our live financial tracking"></a>
                </div>
